...
parser.add_argument("--multi_channel", type=int, default=128)
parser.add_argument("--randomwalk_laplacian", type=bool, default=False)
parser.add_argument("--attention_channel", type=int, default=32)
parser.add_argument("--kernel_size", type=int, default=3)
parser.add_argument("--gcnn_channel", type=int, default=32)  # same
parser.add_argument("--gconv_channel", type=int, default=64)  # same
